...
export default function NewPlaceB (props){
    ...
    return (<div className={classes.root}>
        <Card className={classes.card}>
            ...
            <CardActions>
                <Button color="primary" variant="contained" disabled={values.text === ''} onClick={clickPlace} className={classes.submit}>POST</Button>
            </CardActions>
        </Card>
    </div>)
